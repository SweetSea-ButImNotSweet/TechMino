...
function scene.keyDown(key,isRep)
    ...
    elseif key=='a' then
        if _testButton(3) then
            MES.new("error","Techmino WTF doesn't support original Techmino's Multiplayer feature!",2.62)
        end
    elseif key=='z' then
...
scene.widgetList={
    ...
    WIDGET.newKey   {name='online', x=-1200,y=450,w=800,h=100,color='lV',font=45,align='R',edge=30,code=pressKey'a'},
    ...
    WIDGET.newButton{name='music',  x=330,y=80,w=100,         color='lY',code=pressKey'2',font=70,fText=CHAR.icon.music},
